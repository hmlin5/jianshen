...
//字符验证
jQuery.validator.addMethod("resourceTitle", function(value, element) {
	var result = false;
	if(/^[a-zA-Z0-9\u4e00-\u9fa5]+$/.test(value) || /['";><%]/im.test(value)){
		result = true;
	}
...
jQuery.validator.addMethod("mobile", function(value, element) {
    ...
    //return this.optional(element) || (length == 11 && /^(((13[0-9]{1})|(18[0-9]{1})|(15[0-9]{1}))+\d{8})$/.test(value));
    return this.optional(element) || (length == 11 && /(^1[3,5,8]\d{9}$)/g.test(value));
}, "请正确填写您的手机号码");
