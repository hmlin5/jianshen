...
<input type="text" id="${name}" name="${name}" maxlength="5" class="txt required" placeholder="验证码" style="width:255px;${inputCssStyle}"/>
<img src="${pageContext.request.contextPath}/servlet/validateCodeServlet" onclick="$('.${name}Refresh').click();" class="mid ${name} code" style="${imageCssStyle}"/>
