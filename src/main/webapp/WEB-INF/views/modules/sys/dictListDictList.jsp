...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/dict/dictListDictList?type=equipment_type">字典列表</a></li>
		<shiro:hasPermission name="sys:dict:edit"><li><a href="${ctx}/sys/dict/form?sort=10">字典添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="dict" action="${ctx}/sys/dict?type=equipment_type" method="post" class="breadcrumb form-search">
