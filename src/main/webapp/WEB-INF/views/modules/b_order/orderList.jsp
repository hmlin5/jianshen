...
<body>
	...
	<form:form id="searchForm" modelAttribute="order" action="${ctx}/b_order/order/" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="order">
			<tr>
				...
				<shiro:hasPermission name="b_order:order:edit"><td>
					...
					<a href="${ctx}/b_order/order/updateStatus?id=${order.id}" onclick="return confirmx('确认该订单吗？', this.href)">确认</a>
					</c:if>
