...
<script src="${ctxStatic}/uploadify/jquery.Huploadify.js" type="text/javascript"></script>
<link href="${ctxStatic}/uploadify/Huploadify.css" type="text/css" rel="stylesheet" />
