 ...
 * 
 */
package com.gimc.user.modules.b_movement.entity;
 ...
 * @version 2018-05-03
 */
public class Movement extends DataEntity<Movement> {
	...
	//传递参数
	private boolean containFlag = false; //sql查询包含标识
	...
	@Length(min=0, max=256, message="所属分类id长度必须介于 0 和 256 之间")
	...
	@Length(min=0, max=512, message="所属分类名称长度必须介于 0 和 512 之间")
	...
	@Length(min=0, max=4, message="是否使用器材长度必须介于 0 和 2 之间")
	...
	@Length(min=0, max=256, message="预备动作图片url长度必须介于 0 和 256 之间")
	...
	@Length(min=0, max=256, message="执行动作图片url长度必须介于 0 和 256 之间")
