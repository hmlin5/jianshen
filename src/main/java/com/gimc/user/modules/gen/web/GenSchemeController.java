 ...
 * 
 */
package com.gimc.user.modules.gen.web;
...
import com.gimc.user.modules.gen.service.GenSchemeService;
import com.gimc.user.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.gimc.user.modules");
		}
