...
public class HttpUtil {
	...
	public static void main(String[] args) {
		...
		// map.put("userid", BeeplayConstant.userId);
		// map.put("passwd", BeeplayConstant.passwd);
		// String result = HttpUtil.get(BeeplayConstant.interfaceAddress
		// + "v1/oms/user/login", map, 3000, 3000, "UTF-8");
		// System.out.println(result);
		
		Map<String, String> map1 = new HashMap<String, String>();
		map1.put("limit", "500");
		map1.put("offset", "0");
		map1.put("direction", "asc%2Cdesc");
		map1.put("field", "rank%2Cpriority");
		map1.put("word", "摩拜单车");
		map1.put("fuzzy", "1");
		map1.put("country", "CN");
		String postRequest = "";
		try {
			postRequest = HttpUtil.get(
					"http://backend.cqaso.com/app/1044535426/asoWord", map1,
					3000, 3000, "UTF-8");
		} catch (Exception e) {
		 ...
		 headers.put("X-Apple-Store-Front", "143465-19,26");
		 map.put("mt", "8");
		 map.put("id", "1044535426");
		 try {
		 String postRequest = HttpUtil
				  .get("https://itunes.apple.com/WebObjects/MZStore.woa/wa/viewSoftware",
		 map, headers, 3000, 3000, "UTF-8");
